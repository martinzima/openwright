...
export class TestStatsApiService {
  ...
  async fetchTestStats(period: TimePeriod): Promise<TestStats> {
    ...
    let stats: TestStats = {
      ...
      history: [
        { date: 'Day 1', passed: 15, failed: 2 },
        { date: 'Day 2', passed: 18, failed: 1 },
        { date: 'Day 3', passed: 22, failed: 3 },
        { date: 'Day 4', passed: 30, failed: 1 },
        { date: 'Day 5', passed: 25, failed: 0 },
        { date: 'Day 6', passed: 28, failed: 1 },
    ...
    if (period === '30d') {
      stats = {
        /* ... 30d data ... */ total: { value: 620, changePercent: 12.5 },
        ...
        history: [
          { date: 'Week 1', passed: 130, failed: 15 },
          { date: 'Week 2', passed: 145, failed: 10 },
          { date: 'Week 3', passed: 160, failed: 8 },
          { date: 'Week 4', passed: 155, failed: 12 },
        ],
        passRateBySuite: [
      ...
      stats = {
        /* ... 90d data ... */ total: { value: 1800, changePercent: 18.2 },
        ...
        history: [
          { date: 'Month 1', passed: 500, failed: 40 },
          { date: 'Month 2', passed: 550, failed: 35 },
        ...
        passRateBySuite: [
          ...
          { suiteName: 'API', passRate: 0.9, totalRuns: 60 },
      ...
      stats = {
        /* ... all time data ... */ total: { value: 5000, changePercent: 25.0 },
        ...
        history: [
          { date: 'Q1', passed: 1000, failed: 100 },
          { date: 'Q2', passed: 1200, failed: 80 },
          { date: 'Q3', passed: 1300, failed: 70 },
          { date: 'Q4', passed: 1500, failed: 50 },
        ],
        passRateBySuite: [
          ...
          { suiteName: 'E2E B', passRate: 0.9, totalRuns: 120 },
